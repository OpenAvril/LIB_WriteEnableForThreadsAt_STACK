...
uint8_t* OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Control::_stat_REG_ptr_writeCycle_Try_ThreadId_Index;
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Control::stat_REG_boot1_DEFINE_ptr_flag_praisingWrite()
    {
        _stat_REG_ptr_flag_praisingWrite = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Control::stat_REG_boot1_DEFINE_ptr_3STATE_flag_WriteState()
    {
        _stat_REG_LIST_Of_3STATE_flag_WriteState = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Control::stat_REG_boot1_DEFINE_ptr_WriteACTIVE_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteACTIVE_Count_For_ThreadId = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Control::stat_REG_boot1_DEFINE_ptr_WriteIDLE_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteIDLE_Count_For_ThreadId = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Control::stat_REG_boot1_DEFINE_ptr_WriteWAIT_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteWAIT_Count_For_ThreadId = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Control::stat_REG_boot1_DEFINE_ptr_new_writeCycle_Try_ThreadId_Index()
    {

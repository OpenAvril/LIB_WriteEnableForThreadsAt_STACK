#include "pch.h"
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::boot3_REG_INITIALISE_WriteEnableForThreadsAt_STACK_Global(OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::boot4_PGM_INSTANTIATE_WriteEnableForThreadsAt_STACK_Global(OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Framework* obj)
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot1_DEFINE_ptr_3STATE_flag_IDLE()
    {
        _REG_ptr_3STATE_flag_IDLE = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot1_DEFINE_ptr_3STATE_flag_WAIT()
    {
        _REG_ptr_3STATE_flag_WAIT = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot1_DEFINE_ptr_3STATE_flag_WRITE()
    {
        _REG_ptr_3STATE_flag_WRITE = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot1_DEFINE_ptr_number_Of_Implemented_Threads()
    {
        _REG_ptr_number_Of_Implemented_Threads = NULL;
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot2_SUBSTANTIATE_ptr_3STATE_flag_IDLE()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot2_SUBSTANTIATE_ptr_3STATE_flag_WAIT()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot2_SUBSTANTIATE_ptr_3STATE_flag_WRITE()
    {
    ...
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot2_SUBSTANTIATE_ptr_number_Of_Implemented_Threads()
    {
        _REG_ptr_number_Of_Implemented_Threads = new uint8_t(UINT8_MAX);
        while (stat_REG_get_ptr_number_Of_Implemented_Threads() == NULL) {}
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot3_INITIALISE_ptr_3STATE_flag_IDLE()
    {
        *_REG_ptr_3STATE_flag_IDLE = { false, false };
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot3_INITIALISE_ptr_3STATE_flag_WAIT()
    {
        *_REG_ptr_3STATE_flag_WAIT = { false, true };
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot3_INITIALISE_ptr_3STATE_flag_WRITE()
    {
        *_REG_ptr_3STATE_flag_WRITE = { true, false };
    }
    void OpenAvrilCLIBWriteEnableForThreadsAtSTACK::WriteEnableForThreadsAt_STACK_Global::stat_REG_boot3_INITIALISE_ptr_number_Of_Implemented_Threads()
    {

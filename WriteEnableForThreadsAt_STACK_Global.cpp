...
// pointers.
    // classes.
    // registers.
    std::array<bool, 2>* OpenAvrilLIB::WriteEnableForThreadsAt_STACK_Global::_ptr_2bit_flag_write_IDLE = NULL;
    std::array<bool, 2>* OpenAvrilLIB::WriteEnableForThreadsAt_STACK_Global::_ptr_2bit_flag_write_WAIT = NULL;
    std::array<bool, 2>* OpenAvrilLIB::WriteEnableForThreadsAt_STACK_Global::_ptr_2bit_flag_write_WRITE = NULL;
    uint8_t* OpenAvrilLIB::WriteEnableForThreadsAt_STACK_Global::_ptr_number_Of_Implemented_Threads = NULL;

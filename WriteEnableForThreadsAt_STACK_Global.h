...
// public.
    // get.
        ...
        int8_t get_number_Of_Implemented_Threads();
    // set.
...
// private.
    ...
    // set.
        void set_Item_Of_2bit_flag_write_IDLE(int8_t slot, bool newValue);
        void set_Item_Of_2bit_flag_write_WAIT(int8_t slot, bool newValue);
        void set_Item_Of_2bit_flag_write_WRITE(int8_t slot, bool newValue);
        ...
        void set_number_Of_Implemented_Threads(int8_t newValue);
    };
}
